...
# Full training split with view labels merged in
# (built from labels_output.csv -> ready_for_training_clustered_anatomical_with_means_with_views.csv)
SOURCE_CSV = "ready_for_training_clustered_anatomical_with_means_with_views.csv"
CROP_ROOT = Path("data/center_roi_images/processed_images_448")
# Single-target ACD regression for center-view subset.
